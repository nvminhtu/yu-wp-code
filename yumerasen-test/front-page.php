<?php get_header(); ?>
	...
	<div id="main" class="clearfix">
		...
		<!-- content start -->
		<div id="content">
			<p class="mt15 index_title" data-label="ピックアップコンテンツ"><img src="<?php bloginfo('template_url'); ?>/images/index_h3_01.jpg" width="950" height="80" alt="ピックアップコンテンツ" /></p>
			<!-- inner start -->
			<div id="inner" class="clearfix">
              <div class="wasaikyoushitsu mr20 clearfix index_pickup">
                <p class="image_r mr10"><img src="<?php bloginfo('template_url'); ?>/images/indeximg_01.jpg" width="70" height="175" alt="和裁教室" class="index_pickup_title" /></p>
<?php
...
wp_reset_query();
?>
                <p class="index_pickup_btn"><a href="<?php echo get_term_link('wasai','category'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/btn01_off.jpg" width="208" height="30" alt="一覧はこちら" /></a></p>
              </div>

              <div class="wayuukai clearfix index_pickup">
                <p class="image_r mr10"><img src="<?php bloginfo('template_url'); ?>/images/indeximg_02.jpg" width="70" height="185" alt="和遊会" class="index_pickup_title" /></p>
<?php
...
wp_reset_query();
?>
                <p class="index_pickup_btn"><a href="<?php echo get_term_link('wayukai','category'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/btn01_off.jpg" width="208" height="30" alt="一覧はこちら" /></a></p>
              </div>

              <div id="inner">
              <div class="kitsuke clearfix mr20 index_pickup">
                <p class="image_r mr10"><img src="<?php bloginfo('template_url'); ?>/images/indeximg_03.jpg" width="70" height="175" alt="着付け教室" class="index_pickup_title" /></p>
                <?php
...
wp_reset_query();
?>
				<p class="index_pickup_btn"><a href="<?php echo get_term_link('kitsuke','category'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/btn01_off.jpg" width="208" height="30" alt="一覧はこちら" /></a></p>
			  </div>
              <div class="kiarai clearfix index_pickup">
...
-->
                <p class="image_r mr10"><img src="<?php bloginfo('template_url'); ?>/images/indeximg_11.jpg" width="70" height="175" alt="お客様の声" class="index_pickup_title" /></p>
                <?php
...
wp_reset_query();
?>
				<p class="index_pickup_btn"><a href="<?php echo get_term_link('voice','category'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/btn01_off.jpg" width="208" height="30" alt="一覧はこちら" /></a></p>
              </div>
			</div>
			<!-- inner end -->
