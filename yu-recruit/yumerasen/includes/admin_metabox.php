...
class Videoprefix_Admin {
	/**
 	 ...
 	 * @var string
 	 */
	private $key = 'prefixvideo_options';
	/**
 	 * Options page metabox id
 	 * @var string
 	 */
	private $metabox_id = 'prefixvideo_option_metabox';
	/**
	 * Options Page title
	 * @var string
	 */
	...
	private function __construct() {
		// Set our title
		$this->title = __( 'Video Options', 'prefixvideo' );
	}
	/**
	...
	function add_options_page_metabox() {
		...
		// Set our CMB2 fields
		$cmb->add_field( array(
			'name' => __( 'Your Youtube API Key', 'prefixvideo' ),
			'desc' => __( 'insert your youtube API key', 'prefixvideo' ),
			'id'   => 'youtube_api_key',
			'type' => 'text',
			'default' => '',
		) );
    $cmb->add_field( array(
			'name' => __( 'Your User Name of Youtube', 'prefixvideo' ),
			'desc' => __( 'insert your Youtube username', 'prefixvideo' ),
			'id'   => 'youtube_username',
			'type' => 'text',
			'default' => '',
		) );
