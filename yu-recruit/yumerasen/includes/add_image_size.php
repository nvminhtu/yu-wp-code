...
if ( function_exists( 'add_image_size' ) ) { 
	...
	bt_add_image_size( 'product-feature', 150, 200, array( 'center', 'top' ) );
	//	bt_add_image_size( 'product-feature_large', 1050, 1050, array( 'center', 'top' ) );t
		
		//	bt_add_image_size( 'product-screenshot', 300, 300, array( 'left', 'top' ) );
		
}//Apply AddQuicktag for custom post type
