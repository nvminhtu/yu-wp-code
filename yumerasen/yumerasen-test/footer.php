...
<div id="footer">
      <div id="footer02 clearfix">
        <div class="w275 fl inline footer_logo"><img src="<?php bloginfo('template_url'); ?>/images/footer_rogo.jpg" alt="ゆめらせん　きもの専門店" width="310" height="62" /></div>
        ...
        <div class="fl pt60 clearfix footer_contact">
        ...
        <p class="copyright hidden-pc">Copyright &copy; 夢楽染 All Rights Reserved.</p>
      </div>
	</div>
</div>
...
<script>
jQuery(function($) {
  $('#header_nav_sp_menu').click(function(){
    $('#header_nav_acc').slideToggle();
    if( $(this).hasClass('is-open') ){
      $(this).removeClass('is-open');
      $(this).find('img').attr('src', '<?php bloginfo('template_url'); ?>/images/sp/sp_nav_menu.png');
    } else {
      $(this).addClass('is-open');
      $(this).find('img').attr('src', '<?php bloginfo('template_url'); ?>/images/sp/sp_nav_close.png');
    }
  });
});
</script>
