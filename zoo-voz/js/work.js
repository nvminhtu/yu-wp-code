...
jQuery(function($){
  var ratioYT = $('#ytube').find('iframe').data('ratio');
  var widthYT = $('#ytube').find('iframe').width();
  var heightYT = widthYT / ratioYT;

  console.log(heightYT);
  $('#ytube').find('iframe').height(heightYT);
});
