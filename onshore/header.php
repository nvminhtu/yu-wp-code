...
<body <?php include('includes/id_class_page.php') ?>>
  <div id="wrapper">
    ...
    <div id="header_bg_out" class="clearfix"></div>
      <div class="inner clearfix">
        <h1>外国人ITエンジニア紹介サービス</h1>
        <div class="clearfix">
          <p id="logo"><a href="<?php bloginfo('url'); ?>"><span class="on_logo">On</span>shore<span class="light_logo">.works</span><br />
            <span class="sub_logo">オンショアワークス</span></a></p>
        </div>
        <h2>日本人でも、オフショアでもない。<br />
          「<span>オン</span>ショア人材採用」という選択</h2>
      </div>
    </div>
